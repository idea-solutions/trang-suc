...
var arrayDeal = [
        {
            img : "../assets/img/img-list/1.webp",
            name:"Trâm cài",
            amount:4,
        },
        {
            img : "../assets/img/img-list/2.webp",
            name:"Bông tai",
            amount:22,
        },
        {
            img : "../assets/img/img-list/3.webp",
            name:"Vòng cổ",
            amount:4,
        },
        {
...
function render() {
    var htmlsSlide = arrayImgs.map(img => {
        return `
    ...
    var htmlsItem =arrayDeal.map(item => {
        return `
        <div class="list-item">
...
if(media[0].matches) {
    makeSliderItem(5 ,sliderItems , sliderItemSize , sliderItemAll, sliderItemNext, sliderItemPrev);

}else if(media[1].matches) {
    makeSliderItem(3 ,sliderItems , sliderItemSize , sliderItemAll, sliderItemNext, sliderItemPrev);
...
if(media[3].matches) {
    makeSliderItem(2 ,sliderItems , sliderItemSize , sliderItemAll, sliderItemNext, sliderItemPrev);
...
// js responsive
if(media[0].matches) {
 makeSliderItem(1,customer , customerSize , customerAll, nextCustomer, prevCustomer);
  
} 
if(media[1].matches) {
    makeSliderItem(0,customer , customerSize , customerAll, nextCustomer, prevCustomer);
